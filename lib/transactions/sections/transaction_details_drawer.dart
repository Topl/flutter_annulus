          ...
          children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(
                    width: 172,
                    child: CustomTextLeft(desc: Strings.proposition)),
                const SizedBox(
                  width: 24,
                ),
                CustomTextRight(desc: transaction!.proposition)
              ],
            ),
            Row(
              children: [
                const Spacing(),
                const SizedBox(
                    width: 172, child: CustomTextLeft(desc: Strings.quantity)),
                const SizedBox(
                  width: 24,
                ),
            ...
            Row(
              children: [
                const Spacing(),
                const SizedBox(
                    width: 172, child: CustomTextLeft(desc: Strings.name)),
                const SizedBox(
                  width: 24,
                ),
                CustomTextRight(desc: transaction!.name)
              ],
            ),
          ],
        ),
