...
class ChainInfo extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final AsyncValue<SelectedChainModel> selectedChain = ref.watch(selectedChainProvider);

    final selectedChainNotifier = ref.watch(selectedChainProvider.notifier);

    useEffect(() {
      Future.delayed(
        Duration(seconds: 2),
        () {
          selectedChainNotifier.getSelectedChain();
        },
      );
    }, []);
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  LowerStatWithIcon(
                                      icon: Icons.info_outline, statString: "77%", statSymbol: "Total Stake"),
                                  const VerticalDivider(
                                    indent: 5,
                                    endIndent: 10,
                                    thickness: 1,
