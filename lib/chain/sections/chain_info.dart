...
class ChainInfo extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isTabletOrMobile = ResponsiveBreakpoints.of(context).smallerOrEqualTo(
        TABLET);
      ...
      data: (chain) =>
          Container(
            ...
            decoration: BoxDecoration(
              color: colorTheme == ThemeMode.light ? Colors.white : const Color(
                  0xFF282A2C),
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  child: ResponsiveRowColumn(
                    layout: ResponsiveBreakpoints.of(context).smallerOrEqualTo(
                        MOBILE)
                        ? ResponsiveRowColumnType.COLUMN
                        : ResponsiveRowColumnType.ROW,
                    children: [
                      ...
                      ResponsiveRowColumnItem(
                        rowFlex: 6,
                        child: Column(
                          crossAxisAlignment: !isMobile ? CrossAxisAlignment
                              ...
                              child: ResponsiveRowColumn(
                                ...
                                children: [
                                  ...
                                  ResponsiveRowColumnItem(
                                    rowFlex: 1,
                                    child: LowerStatWithoutIcon(
                                      statValue: chain.averageBlockTime
                                          .toString(),
                              ...
                              child: ResponsiveRowColumn(
                                ...
                                children: [
                                  ...
                                  ResponsiveRowColumnItem(
                                    ...
                                    child: LowerStatWithIcon(
                                      icon: Icons.info_outline,
                                      statString: chain.registeredStakes
                                          .toString(),
                                  ...
                                  ResponsiveRowColumnItem(
                                    ...
                                    child: LowerStatWithIcon(
                                      icon: Icons.info_outline,
                                      statString: '${chain.inactiveStakes
                                          .toString()}%',
                                      statSymbol: "Inactive\nStakes",
                                      firstItem: isMobile,
                                    ),
