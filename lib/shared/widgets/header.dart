          ...
          SizedBox(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(
                  color: colorTheme == ColorMode.light ? const Color(0xFF4B4B4B) : const Color(0xFF858E8E),
                ),
                prefixIcon: Icon(
                  Icons.search,
                  color: colorTheme == ColorMode.light ? const Color(0xFFC0C4C4) : const Color(0xFF4B4B4B),
                ),
