...
void main() async {
  final chainTests = RequiredBlockDetailSliderTests(
    navigateToBlockDetails: (testScreenSize) => tabletBlockDetailsSliderTest(testScreenSize),
...
Future<void> tabletBlockDetailsSliderTest(TestScreenSizes testScreenSize) async =>
